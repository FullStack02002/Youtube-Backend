...
import {Comment} from "../models/videoscomment.model.js"
...
const createComment=asyncHandler(async(req,res)=>{
    ...
    return res.status(200).json(new ApiResponse(201,comment,"Comment Added Succesfully"));
...
const deleteComment=asyncHandler(async(req,res)=>{
    ...
    return res.status(200).json(
        new ApiResponse(200,{commentId},"Comment Deleted Succesfully")
    )
